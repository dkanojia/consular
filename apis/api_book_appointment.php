...
$query = "INSERT INTO `appointments`(  `username`, `mobile`,`imei`,  `passport_no`,`gamca_medical`, `entry_permit`, `booked_date`, `city`, `device_id`) VALUES ('$username', '$mobile','$imei', '$passport_no','$gamca_medical', '$entry_permit', '$booked_date', '$city', '$device_id')";
